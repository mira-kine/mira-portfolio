      ...
      >
        <div className="relative">
          ...
          <div className="relative flex flex-col items-center bg-white w-full rounded-lg md:flex-row md:max-w-2xl dark:bg-charcoal dark:text-white">
            <img
              className="object-contain w-1/2 rounded-full h-1/2 mx-8 my-8 md:h-auto md:my-0 md:w-48 border border-2 border-solid border-coffee"
            ...
            <div className="flex flex-col justify-between p-4 leading-normal bg-charcoal md:bg-charcoal/0">
              ...
              <p className="mb-3 text-charcoal-700 dark:text-white text-xl lg:text-2xl">
                🌱 I am a full stack software developer who cares about people
                and their stories. I am working to curate an accessible,
                equitable and soulful digital world. 🌸 I also love creating and
                learning new things - my personal projects employ a calm,
                user-friendly interface, and my aesthetics are influenced by my
