...
export default function AboutMe() {
  return (
    <div class="snap-center flex flex-col h-screen bg-sunflower">
      <div class="h-full sm:min-w-fit">
        <h1 class="dark:text-white text-1xl sm:text-2xl md:text-5xl xl:text-6xl font-semibold text-charcoal w-7/12">
          About Me
        </h1>
