...
export default function NavBar() {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(
          scrollPosition > 110 ? 'visible' : 'invisible',
          'fixed bottom-8 right-4 flex flex-col justify-center items-end'
        )}
      >
        {showNav && (
          <div className="bg-white mb-4 h-52 rounded-xl shadow-xl">
            <ul className="mx-8 flex flex-col justify-center content-center items-center">
              <li className="font-handwrite text-2xl p-4 hover:text-matcha">
        ...
        <button className="relative group" onClick={() => setShowNav(!showNav)}>
          <div className="relative flex overflow-hidden items-center justify-center rounded-full w-[50px] h-[50px] transform transition-all bg-cyan ring-0 ring-cyan hover:ring-8 group-focus:ring-4 ring-opacity-30 duration-200 shadow-lg shadow-charcoal/30">
