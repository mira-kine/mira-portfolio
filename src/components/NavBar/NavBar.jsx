...
export default function NavBar() {
  ...
  return (
    <div class="border-b-2 shadow-md border-gray-100 pb-5">
          ...
          <div class="flex justify-around">
            ...
            <div class="-my-2 md:hidden">
              <button
                ...
                aria-expanded="false"
              >
                <span class="sr-only text-charcoal">Open menu</span>
                <span class="sr-only text-charcoal">Menu</span>
                <svg
                  class="h-6 w-6"
      ...
      <div id="bar" class="flex justify-center hidden md:flex">
        <div class=" flex flex-col md:flex-row justify-center md:space-y-0 my-2 space-y-4 text-center text-gray-500">
          ...
          <a href="/aboutme" class="mx-8 hover:text-blue-900">
            {' '}
            About Me{' '}
          </a>
          <a href="/projects" class="mx-8 hover:text-blue-900">
            {' '}
            Projects
          </a>
